...
namespace BookServer.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(ITokenGenerator _tokenGenerator, IPasswordHasher _passwordHasher, IUserDAO _userDAO)
        {
        ...
        [HttpPost]
        public ActionResult Login(LoginUser userParam)
        {
            ActionResult result = Unauthorized(new { message = "Username or password is incorrect" });
